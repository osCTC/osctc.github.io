...
(function(root, factory) {
    ...
    var button = function (c, p, t) {
        return createElement("li", {
            class: c,
            html: '<a href="#" class="page-link" data-page="' + p + '">' + t + "</a>"
        });
    };
            ...
            if (j) {
                ...
                if (d - e == 2) i.push(a[e]);
                    ...
                    var f = createElement("li", {
                        class: "ellipsis page-item",
                        html: '<a class="page-link" page-href="#">' + ellipsis + "</a>"
                    });
                    i.push(f);
                }
            }
    ...
    Columns.prototype.sort = function (column, direction, init) {
        ...
        each(rows, function (tr) {
            ...
            var num = (content === !!content) ? content.replace(/(\$|\,|\s|%)/g, "") : content;
    ...
    proto.render = function (type) {
        ...
        // Paginator
        var w = createElement("ul", {
            class: "dataTable-pagination pagination justify-content-center"
        });
